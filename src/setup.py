...
with open(base_dir / 'data/documentation/API/Introduction.doc',
          encoding='utf-8') as f:
...
setup(
    ...
    # maintainer='Albert Zaqaryan',
    # maintainer_email='ITM.Albert.Zaqaryan@gmail.com',

    # This is a one-line description or tagline of what your project does. This
    # corresponds to the "Summary" metadata field:
    # https://packaging.python.org/specifications/core-metadata/#summary
    description="""
        WebSite: Before deploy the site it's necessary to create virtualenv on
                 the machine, then activate installed env and install library
                 of the site
    """,  # Optional
    ...
    url="https://cutt.ly/tTEl1OU",  # Optional
    ...
    project_urls={
        'Bug Reports': 'https://cutt.ly/Zm77RbS',
        'Source': 'https://cutt.ly/vm77xY3'
    },
    ...
    classifiers=[  # Optional
        ...
        "License URL:: https://cutt.ly/wmxuq4r",
